...
El DDL oficial está en **`docs/sql/schema_project_dossier.sql`** (copia del archivo `backend/src/dossier/db/Migracion.md`). Ejecútalo en tu instancia PostgreSQL antes de usar registro/login y dossiers.
