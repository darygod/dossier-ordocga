const messages = {
  ...
  "auth.error.network":
    "No se pudo conectar con la API. Si usas Next en otro puerto (p. ej. 3001), añade ese origen a CORS_ORIGINS en el .env del backend. Comprueba python main.py y NEXT_PUBLIC_API_URL en frontend/.env.local (reinicia npm run dev).",
  ...
  "billing.pro_features_2": "Email + soporte por chat",
  "billing.enterprise_features_0": "Todo Pro + acceso a la API",
  ...
  "billing.plan_free_credits": "10 créditos/mes",
  "billing.plan_pro_credits": "500 créditos/mes",
  "billing.plan_enterprise_credits": "Ilimitado",
  "billing.plan_cap_short": "{limit} cr/mes",
  ...
  "detail.warn_pdl_profile_linkedin": "Se encontró un perfil (LinkedIn: {linkedin}).",
  "detail.warn_pdl_profile_no_linkedin": "Se encontró un perfil (sin LinkedIn en la respuesta).",
  "detail.warn_pdl_rate_limit": "Límite de solicitudes alcanzado. Espera un momento y reintenta.",
  ...
  "depth.option_deep_label": "Profundo",
  ...
  "admin.subtitle": "Usuarios, organizaciones, dossiers y créditos de un vistazo.",
  ...
  "admin.col_created": "Fecha de registro",
  "admin.col_org": "Empresa u organización",
  "admin.col_plan": "Plan",
  "admin.col_credits": "Créditos",
  "admin.col_limit": "Límite mensual",
  "admin.col_dossiers_user": "Dossiers del usuario",
  "admin.col_org_url": "URL de la organización",
  "admin.col_members": "Miembros",
  "admin.col_dossiers_org": "Dossiers de la organización",
  "admin.col_subject": "Nombre investigado",
  "admin.col_status": "Estado",
  "admin.col_credits_used": "Créditos consumidos",
  ...
  "overview.microsoft_no_connection":
    "Tocá «Conectar Outlook» e iniciá sesión con Microsoft.",
  "overview.microsoft_connected_hint": "Tus reuniones y dossiers generados los ves en",
  "overview.microsoft_events_empty":
    "No hay reuniones próximas. Creá un evento en Outlook con «Empresa:» y «Contacto:» en la descripción.",
  ...
  "calendar.guide.subject_examples":
    "Reunión comercial — Tesla\nReunión con Acme Corp\nMeeting with Acme Corp\nLlamada con Acme Corp",
  "overview.calendar_enrichment_diagnostics": "Avisos del informe",
  ...
  "overview.google_no_connection":
    "Tocá «Conectar Google Calendar» e iniciá sesión con Google.",
  "overview.google_connected_hint": "Tus eventos y dossiers generados los ves en",
  "overview.google_events_empty":
    "No hay eventos próximos. Creá uno en Google Calendar con «Empresa:» y «Contacto:» en la descripción.",
  ...
  "quick.search_desc": "Ver dossiers guardados",
  ...
  "quick.person_research_desc": "Investigación de persona",
  "quick.corporate_label": "Empresas",
  "quick.corporate_desc": "Dossier de empresa",
  ...
  "automation.calendar_meetings_heading": "Próximas reuniones",
  ...
  "automation.calendar_refresh": "Actualizar",
  "automation.calendar_past_badge": "Pasada",
  "automation.calendar_location": "Ubicación",
  "automation.calendar_all_day": "Todo el día",
  ...
  "settings.nav_account": "Cuenta y seguridad",
  "settings.account.title": "Cuenta y seguridad",
  "settings.account.subtitle":
    "Actualiza tu correo de acceso, cambia la contraseña o elimina tu cuenta de forma permanente.",
  "settings.account.email_section": "Correo electrónico",
  "settings.account.email_current": "Correo actual",
  "settings.account.email_new": "Nuevo correo",
  "settings.account.password_section": "Contraseña",
  "settings.account.password_current": "Contraseña actual",
  "settings.account.password_new": "Nueva contraseña",
  "settings.account.password_confirm": "Confirmar nueva contraseña",
  "settings.account.change_email": "Guardar nuevo correo",
  "settings.account.change_password": "Actualizar contraseña",
  "settings.account.saving": "Guardando…",
  "settings.account.success_email": "Correo actualizado correctamente.",
  "settings.account.success_password": "Contraseña actualizada correctamente.",
  "settings.account.error_email_required": "Introduce un correo válido.",
  "settings.account.error_password_short": "La contraseña debe tener al menos 8 caracteres.",
  "settings.account.error_password_mismatch": "Las contraseñas nuevas no coinciden.",
  "settings.account.error_delete_confirm": "Escribe DELETE para confirmar la eliminación.",
  "settings.account.delete_title": "Eliminar cuenta",
  "settings.account.delete_desc":
    "Se eliminarán de forma permanente tu usuario, el espacio personal y los dossiers que hayas creado. No se puede deshacer.",
  "settings.account.delete_type_confirm": "Escribe DELETE para confirmar",
  "settings.account.delete_confirm":
    "¿Seguro? Tu cuenta y tus datos se eliminarán de forma permanente.",
  "settings.account.delete_button": "Eliminar mi cuenta",
  "settings.account.deleting": "Eliminando…",
  "backend.error_wrong_password": "Contraseña incorrecta.",
  "backend.error_email_in_use": "Ya existe una cuenta con este correo.",
  "backend.error_account_sole_admin":
    "Eres el único administrador de una organización con más miembros. Asigna otro administrador antes.",
  "backend.error_account_platform_admin":
    "No puedes eliminar una cuenta con rol de administrador de plataforma. Quita ese rol antes.",
  ...
  "settings.members.invite_email_placeholder": "nombre@empresa.com",
  "settings.members.invite_email_placeholder_domain": "nombre@{domain}",
  ...
  "settings.members.error_invite_wrong_domain":
    "Solo puedes invitar correos del dominio @{domain}.",
  ...
  "locale.en": "Inglés (EE. UU.)",
  "locale.en_gb": "Inglés (RU)",
  "locale.es": "Español",
  "locale.pt": "Portugués",
  "locale.it": "Italiano",
  "locale.fr": "Francés",
  "locale.de": "Alemán",
  "timezone.utc": "UTC",
  "timezone.pacific": "Hawái y Pacífico",
  "timezone.us_west": "Costa oeste EE. UU.",
  "timezone.us_mountain": "Montaña EE. UU.",
  "timezone.us_central": "Centro EE. UU.",
  "timezone.us_east": "Costa este EE. UU.",
  "timezone.mexico": "México y Centroamérica",
  "timezone.colombia_peru": "Colombia y Perú",
  "timezone.chile": "Chile",
  "timezone.brazil": "Brasil y Argentina",
  "timezone.uk": "Reino Unido",
  "timezone.spain": "España y Portugal",
  "timezone.central_europe": "Europa central",
  "timezone.gulf": "Medio Oriente y Golfo",
  "timezone.india": "India",
  "timezone.southeast_asia": "Sudeste asiático",
  "timezone.japan_korea": "Japón y Corea",
  "timezone.australia": "Australia y Nueva Zelanda",
  "timezone.europe_london": "Londres",
  "timezone.europe_paris": "París",
  "timezone.america_new_york": "Nueva York",
  "timezone.america_los_angeles": "Los Ángeles",
  "timezone.asia_tokyo": "Tokio",
  "settings.display_language": "Idioma de la Interfaz",
  "settings.timezone": "Zona Horaria",
  "settings.timezone_system": "Automática ({hint})",
