const messages = {
  ...
  "auth.error.network":
    "Cannot reach the API. If Next runs on another port (e.g. 3001), add that origin to CORS_ORIGINS in the backend .env. Check python main.py and NEXT_PUBLIC_API_URL in frontend/.env.local (restart npm run dev).",
